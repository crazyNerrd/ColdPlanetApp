      ...
      >
        <Container maxW={"container.xl"}>
          ...
          >
            ...
            />
            <Box>
              <Heading fontSize={"3xl"} color={"orange"}>
                {title}{" "}
              ...
              <Flex alignItems={"center"} gap={"4"}>
                <CircularProgress
                  ...
                  thickness={"6px"}
                >
                  <CircularProgressLabel fontSize={"lg"} color={"yellow"}>
                ...
                <Text display={{ base: "none", md: "initial" }} color={"green"}>
                  User Score
                </Text>
                {isInWatchlist ? (
                  <Button
              ...
              <Heading fontSize={"xl"} mb={"3"} color={"red"}>
                Overview
              </Heading>
              <Text fontSize={"md"} mb={"3"} color={"green"}>
                {details?.overview}
              </Text>
              <Flex mt="6" gap="2">
